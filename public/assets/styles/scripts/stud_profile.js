$(document).ready(function () {
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: {
            courseName: CryptoJS.AES.decrypt(location.href.split('?')[1].split('=')[1], "Secret Passphrase")
        },
        success: function (data) {
            ...
            if (data.CourseList.length > 0) {
                ...
                $(".SearchCourse").append('<div class="alert alert-danger" role="alert"> Course Details Not found for this search!!</div>');
            }
        },
        error: function (ex) {
