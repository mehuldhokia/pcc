                ...
                <div class="row align-items-center">
                    <div class="border-0 mb-4">
                        <div
                            ...
                            <h3 class="fw-bold mb-0">Edit Carousel</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body pt-0">
                                    <input type="file" id="dropify-image" name="blob"
                                        data-default-file="{{ asset('carousel/' . $carousel->blob) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="card">
                            <div class="card-header py-3 d-flex justify-content-between bg-transparent border-bottom-0">
                                <h6 class="mb-0 fw-bold ">Edit Carousel information</h6>
                            </div>
                            <div class="card-body pt-0">
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="title" name="title"
                                            ...
                                            placeholder="Enter Fullname" value="{{ $carousel->title }}" required>
                                        @error('title')
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="description" name="description" class="form-control @error('description') is-invalid @enderror"
                                            placeholder="Enter Description" rows="4">{{ $carousel->description }}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
