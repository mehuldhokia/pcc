                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" id="course_code" name="course_code"
                                            ...
                                            placeholder="Enter Course Code" value="{{ $course->course_code }}" required>
                                        @error('course_code')
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" id="amount" name="amount"
                                                ...
                                                placeholder="Enter Amount" value="{{ $course->amount }}" required>
                                            @error('amount')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="row g-3 align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <select id="duration" name="duration" class="form-select"
                                            ...
                                            <option value="6 Months" @if ($course->duration == '6 Months') selected @endif>6
                                                Months</option>
                                            <option value="1 Year" @if ($course->duration == '1 Year') selected @endif>1
                                                Year</option>
                                            <option value="2 Years" @if ($course->duration == '2 Years') selected @endif>2
                                                Years</option>
                                            <option value="3 Years" @if ($course->duration == '3 Years') selected @endif>3
                                                Years</option>
                                            <option value="4 Years" @if ($course->duration == '4 Years') selected @endif>4
                                                Years</option>
                                        </select>
                                        @error('duration')
                                            <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="qualification" name="qualification"
                                            ...
                                            placeholder="Enter Qualification" value="{{ $course->qualification }}"
                                            required>
                                        @error('qualification')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                    ...
                                    <div class="sticky-lg-top">
                                        <div class="card">
                                            <div class="card-header py-3 bg-transparent border-bottom-0">
                                                ...
                                                <small class="d-block text-muted mb-2">File size upto 2MB max and 2000px max-height.</small>
                                            </div>
                                            <div class="card-body pt-0">
                                                <input type="file" name="blob" id="input-file-to-destroy"
                                                    class="dropify" data-max-file-size="2M" data-max-height="2000"
                                                    data-default-file="{{ asset('course/' . $course->blob) }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
